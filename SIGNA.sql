...
@ESPECIE INT = NULL
AS
	SELECT DISTINCT ATR.*,DESCRICAO FROM TBATRIBUTO ATR LEFT JOIN TBATRI_ESPECIE ASS ON ATR.IDATRIBUTO = ASS.IDATRIBUTO WHERE ASS.IDESPECIE = @ESPECIE OR ASS.IDESPECIE IS NULL
	UNION
