...
-- INSERT INTO TBESPECIE (NOMECIE,NOMEPOP,FAMILIA,HABITAT,ALTURA,IMAGEM,DESCRICAOIMG,DATACAD,IDCADADM) VALUES ('Nome CietíficoTeste','Nome PopTeste','FamíliaTeste','HabitatTeste',999.99,NULL,NULL,'27/08/2024',1)
-- DELETE TBESPECIE
GO
...
-- INSERT INTO TBESPECIME (IDESPECIE,DATPLANT,DATACAD,IMAGEM,DESCRICAOIMG,ESTADO,COORD,DAP,IDCADADM) VALUES (1,GETDATE()-10,GETDATE(),NULL,NULL,'1','-23.336055, -46.722261',15,1)
GO
