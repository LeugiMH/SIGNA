...
class Especie
{
    ...
    function listar()
    {
        ...
        $cmd = $con->prepare("SELECT ESP.*,NOME FROM TBESPECIE ESP JOIN TBADMIN ADM ON ESP.IDCADADM = ADM.IDADMIN ORDER BY ESP.NOMEPOP ASC");
    ...
    function listarAdm()
    {
        ...
        //Preparar comando SQL para retornar
        $cmd = $con->prepare("SELECT ESP.*,NOME, (SELECT COUNT(1) FROM TBESPECIME ESP2 WHERE ESP2.IDESPECIE = ESP.IDESPECIE) AS QUANT FROM TBESPECIE ESP JOIN TBADMIN ADM ON ESP.IDCADADM = ADM.IDADMIN HAVING QUANT > 0 ORDER BY ESP.NOMEPOP ASC");
    ...
    function listarUsu()
    {
        ...
        //Preparar comando SQL para retornar
        $cmd = $con->prepare("SELECT ESP.*,NOME, (SELECT COUNT(1) FROM TBESPECIME ESP2 WHERE ESP2.IDESPECIE = ESP.IDESPECIE AND ESP2.ESTADO = '1') AS QUANTATIVA FROM TBESPECIE ESP JOIN TBADMIN ADM ON ESP.IDCADADM = ADM.IDADMIN HAVING QUANTATIVA > 0 ORDER BY ESP.NOMEPOP ASC");
