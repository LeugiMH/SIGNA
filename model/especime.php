...
class Especime
{
    ...
    function buscarTudo()
    {
        ...
        //Preparar comando SQL para retornar
        $cmd = $con->prepare("SELECT TBA.IMAGEM 'IMGESPECIME',TBA.DESCRICAOIMG 'DESCESPECIME',DAP,DATPLANT 'DATPLANT',NOMECIE,NOMEPOP,FAMILIA,HABITAT,CONSERV,ALTURA,COORD,TBB.IDESPECIE,TBB.IMAGEM 'IMGESPECIE',TBB.DESCRICAOIMG 'DESCESPECIE' 
